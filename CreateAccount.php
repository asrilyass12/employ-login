              ...
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <form class="mx-1 mx-md-4" action="#" method="post">
                  ...
                  <i class="bi bi-telephone-fill fa-lg me-3 fa-fw"></i>
                    <div class="form-outline flex-fill mb-0">
                      <input type="number" name="phone" id="form3Example4c" class="form-control" />
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div class="form-outline flex-fill mb-0">
                      <input type="password" name="password" id="form3Example4c" class="form-control" />
                      <label class="form-label" for="form3Example4c">Confirme Password</label>
                    </div>
                  </div>
...
<?php
  ...
  $sql = "INSERT INTO first_login.register (first_name, last_name, email, phone, password) VALUES ('". $fname ."', '". $lname ."', '". $email ."', '" . $phone ."','". $password ."')";
